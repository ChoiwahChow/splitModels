...
private:
	...
	static void calc_ternary_invariant_vec(int domain_size, int* mt, int** inv_vec, bool no_calc = false);
	static void calc_unary_invariant_vec(int domain_size, int* mt, int** inv_vec, bool no_calc = false);
	static void calc_invariant_vec(int domain_size, int** mt, int** inv_vec, bool no_calc = false);
	static void calc_relation_invariant_vec(int domain_size, int** mt, int** inv_vec, bool no_calc = false);
public:
