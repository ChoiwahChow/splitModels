...
public:
	...
	static void calc_invariant_vec(int domain_size, int num_ops, std::vector<int**>& all_mt,
			std::vector<int**>& inv_vec, std::vector<int>& op_type, std::vector<std::string>& op_sym, std::vector<int*>& pre_calced);
	static void hash_key(int domain_size, int** inv_vec, std::string& key);
	static void hash_key(int domain_size, int num_ops, int** all_inv_vec, std::string& key);
	static void sort_invariant_vec(int domain_size, int num_ops, int** all_inv_vecc);
};
